    ...
    <body>
        ...
        <script>
            $(document).ready( function () {
                ...
                var miTabla = $('#tablaDevolver').DataTable({
                    destroy: true,
                    responsive: true,
                    processing: true,
                    pageLength: 10,
                    ajax: {
                        url: 'core/tabla_index_devolver.php',
                        type: 'GET',
                    },
                    language: {
                        lengthMenu: '',
                    ...
                    columns: [
                        ...
                        {data: 'estado', observacion:'estado', orderable: true, searchable: true, className: 'dt-body-center'},
